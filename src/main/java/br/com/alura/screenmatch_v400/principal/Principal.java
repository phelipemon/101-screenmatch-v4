package br.com.alura.screenmatch_v400.principal;

import br.com.alura.screenmatch_v400.models.*;
import br.com.alura.screenmatch_v400.repository.SerieRepository;
import br.com.alura.screenmatch_v400.service.ConsumoApi;
import br.com.alura.screenmatch_v400.service.ConverteDados;
...
//                System.out.println(s.getTitulo() + "  - avaliação: " + s.getAvaliacao()));
    ...
    private void buscarEpisodioPorTrecho() {
        ...
        List<Episodios> episodiosEncontrados = repository.episodiosPorTrecho(trechoEpisodio);
